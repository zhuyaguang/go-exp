...
import (
	v1 "crd-controller-demo/pkg/apis/stable/v1"
	"crd-controller-demo/pkg/client/clientset/versioned/scheme"
...
// CrdV1Client is used to interact with features provided by the crd.test.com group.
type CrdV1Client struct {
	restClient rest.Interface
}

func (c *CrdV1Client) CronTabs(namespace string) CronTabInterface {
