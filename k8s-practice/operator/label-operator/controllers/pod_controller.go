...
//+kubebuilder:rbac:groups=core.my.domain,resources=pods,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.my.domain,resources=pods/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.my.domain,resources=pods/finalizers,verbs=update
...
func (r *PodReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	*/
	...
	if err := r.Get(ctx, req.NamespacedName, &pod); err != nil {
		...
		fmt.Println(err, "unable to fetch Pod")
	...
	*/
	...
	if err := r.Update(ctx, &pod); err != nil {
		fmt.Println(err, "unable to update Pod")
		return ctrl.Result{}, err
	}
